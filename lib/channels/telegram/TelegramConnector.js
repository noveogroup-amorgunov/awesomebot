...
var _nodeTelegramBotApi2 = require('node-telegram-bot-api');

var _nodeTelegramBotApi3 = _interopRequireDefault(_nodeTelegramBotApi2);
...
class TelegramConnector extends _events2.default {
    ...
    constructor({ token, options = { polling: true } }) {
        super();
        const _nodeTelegramBotApi = new _nodeTelegramBotApi3.default(token, options);
